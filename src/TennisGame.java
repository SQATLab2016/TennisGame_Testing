...
// "player2 wins"
			...
			if (player2Points >= 4 && player2Points - player1Points == 1)   //Bug Here! (> 4) should be (4 >= 4)
				return "player2 has advantage";							
			
			return  player1Score + " - " + player2Score ;     // Bug Here! (player2Score + " - " + player1Score ;) Should be (player1Score + " - " + player2Score ;)
	}
}